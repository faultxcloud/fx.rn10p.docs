...
- Flash [Firmware Only]({{ site.baseurl }}/docs/5-rom/2-firmware.html) (if necessary)
- Flash LineageOS ROM
- Flash [GApps]({{ site.baseurl }}/docs/6-gapps/index/) **(MindTheGapps)**: Android 14 or Android 15
- Format Data ➜ **"YES"**
- Reboot System