...
Halaman resmi dari Xiaomi **(Mi.com)** untuk **memeriksa dan memverifikasi perangkat Xiaomi menggunakan nomor IMEI**.  
...
2. Buka link ini → [**Product Authentication**](https://www.mi.com/global/verify/#/en/tab/imei){:target="_blank"}
