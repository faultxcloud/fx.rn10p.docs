...
- DataBackup (root): [Download](https://github.com/XayahSuSuSu/Android-DataBackup/releases) <img src="{{ 'assets/icons/check-green.png' | relative_url }}" width="16" style="vertical-align:middle;">
- Swift Backup (root): [Download](https://play.google.com/store/apps/details?id=org.swiftapps.swiftbackup&hl=en&gl=US)  
