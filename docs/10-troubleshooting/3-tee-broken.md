...
## <i class="bi bi-terminal"></i> Fix TEE Broken
...
- Flash [Engineering ROM]({{ site.baseurl }}/docs/5-rom/7-engineering-rom.html) using [MiFlash Tools]({{ site.baseurl }}/3-tools/3-xiaomi-tools.html) (flash all)
